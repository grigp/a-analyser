...
include(build/tester/tester_src.pri)
...
include(metodics/metodics_tester_src.pri)
...
include(painters/painters_tester_src.pri)
include(visual_widgets/visual_widgets_tester_src.pri)
include(personal_programs/personal_programs_tester_src.pri)
