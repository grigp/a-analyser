#ifndef EVOLVENTATEMPLATE_H
#define EVOLVENTATEMPLATE_H

#include <QObject>

#include "metodictemplate.h"

class EvolventaTemplate : public MetodicTemplate
{
    Q_OBJECT
public:
    explicit EvolventaTemplate(QObject *parent = nullptr);
