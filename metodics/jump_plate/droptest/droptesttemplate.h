#ifndef DROPTESTTEMPLATE_H
#define DROPTESTTEMPLATE_H
...
/*!
 * \brief Шаблон методики дроп теста DropTestTemplate class
 */
class DropTestTemplate : public MetodicTemplate
{
    Q_OBJECT
public:
    explicit DropTestTemplate(QObject *parent = nullptr);
