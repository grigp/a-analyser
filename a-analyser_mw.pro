...
TRANSLATIONS += a-analyser_mw_en_US.ts #a-analyser_mw_de_DE.ts
...
include(build/mas_wrestling/mas_wrestling_src.pri)
include(client_widgets/client_widgets_src.pri)
include(kernel/kernel_src.pri)
include(metodics/metodics_mw_src.pri)
include(metodics_common/metodics_common_mw_src.pri)
include(drivers/drivers_mw_src.pri)
include(service/service_mw_src.pri)
include(factors/factors_mw_src.pri)
include(signal_analysis/signal_analysis_mw_src.pri)
include(summaries/summaries_src.pri)
include(signal_export/signal_export_src.pri)
include(painters/painters_mw_src.pri)
include(visual_widgets/visual_widgets_mw_src.pri)
include(personal_programs/personal_programs_mw_src.pri)
...
win32:RC_FILE = a-analyser_mw.rc
