...
public:
    ...
    void setValueUp(const int value) {m_valueUp = value;}
    int valueUp() const {return m_valueUp;}

    void setValueDown(const int value) {m_valueDown = value;}
    int valueDown() const {return m_valueDown;}

    void setValueRight(const int value) {m_valueRight = value;}
    int valueRight() const {return m_valueRight;}

    void setValueLeft(const int value) {m_valueLeft = value;}
...
private:
    ...
    QColor m_frontalColor {Qt::blue};
    QColor m_sagittalColor {Qt::red};
